...
//  console.log("Result-Data --->", result);
 ...
 // console.log("Result-Data --->", result);
  ...
  const myfun = async (userEmail) => {
   // console.log(">>>>>UserEmail" , userEmail);
    ...
    //console.log("User1 Detail-->",user1);
 ...
 // console.log("result",sessionStorage.getItem("firstName"));
  return (
    <div>
      <AdminNavbar />
      <h1 className="text-center text-danger">
        Welcome Admin {sessionStorage.getItem("firstName")}
      </h1>
